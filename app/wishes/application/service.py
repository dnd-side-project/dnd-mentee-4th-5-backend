...
class WishApplicationService:
    ...
    def create_wish(
        self, input_dto: CreateWishInputDto, drink_application_service: DrinkApplicationService
    ...
    def delete_wish(
        self, input_dto: DeleteWishInputDto, drink_application_service: DrinkApplicationService
