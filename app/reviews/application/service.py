...
class ReviewApplicationService:
    ...
    def create_review(
        self, input_dto: CreateReviewInputDto, drink_application_service: DrinkApplicationService
    ...
    def update_review(
        self, input_dto: UpdateReviewInputDto, drink_application_service: DrinkApplicationService
        ...
        try:
            ...
            drinks_input_dto = UpdateDrinkReviewInputDto(
                drink_id=str(review.drink_id), old_drink_rating=old_rating, new_drink_rating=input_dto.rating
            )
    ...
    def delete_review(
        self, input_dto: DeleteReviewInputDto, drink_application_service: DrinkApplicationService
