...
def sample_drink_list():
    drink_dicts = [
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_1"))
            ),
            "drink_name": "wine_1",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_2"))
            ),
            "drink_name": "wine_2",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_3"))
            ),
            "drink_name": "wine_3",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_4"))
            ),
            "drink_name": "beer_1",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_5"))
            ),
            "drink_name": "beer_2",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_6"))
            ),
            "drink_name": "beer_3",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_7"))
            ),
            "drink_name": "liquor_1",
        ...
        {
            "drink_id": str(
                DrinkId(value=uuid.uuid5(uuid.NAMESPACE_DNS, "drink_num_8"))
            ),
            "drink_name": "liquor_2",
