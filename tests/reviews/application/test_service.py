...
def review_repository():
    return InMemoryReviewRepositry()
...
review_data = [("review_id", "drink_id", "Jun", 4, datetime.date(2021, 1, 30))]
...
def test_delete_review(review_application_service, review_repository, review_id, drink_id, user_id, rating, created_at):
    ...
    input_dto = DeleteReviewInputDto(id=uuid.uuid5(uuid.NAMESPACE_DNS, review_id))
